...
public class JsonParsers {
	...
	public static WooCommerceObj GetWooComObj( String data) throws NumberFormatException, JSONException, SQLException {
		// TODO Auto-generated constructor stub		
		
		System.out.println("-------------------------- GetWooComObj ---------------------------------");
	...
	if (data.length() > 0 ) {	
		System.out.println("data  something---> "+ data);
		...
		System.out.println("data empty---> "+ data);
	}
		
	System.out.println("-------------------------- End GetWooComObj ---------------------------------");
